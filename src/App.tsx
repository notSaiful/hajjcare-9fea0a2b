...
import DailyHajjTrainingPage from "./pages/DailyHajjTrainingPage";
...
// Keep the public entry route in the initial bundle. A delayed dynamic import
// here left first-time browser visitors on the global Suspense loader even
// though the application shell had already finished loading. Feature pages
// remain lazy-loaded below.
...
const SukoonDashboardPage = lazy(() => import("./pages/FamilyDashboardPage"));
const MapPage = lazy(() => import("./pages/MapPage"));

const SukoonTrackingPage = lazy(() => import("./pages/FamilyPage"));
...
const TravelPreparationGuidePage = lazy(() => import("./pages/TravelPreparationGuidePage"));
...
const CoverIdVerificationPage = lazy(() => import("./pages/CoverIdVerificationPage"));
...
const HajjTrainingRegistrationWizardPage = lazy(() => import("./pages/HajjTrainingRegistrationWizardPage"));
...
const AdminMissionDirectoryPage = lazy(() => import("./pages/AdminMissionDirectoryPage"));
const AdminTrainingVideosPage = lazy(() => import("./pages/AdminTrainingVideosPage"));
const HajjTrainingRegistrationsAdminPage = lazy(() => import("./pages/HajjTrainingRegistrationsAdminPage"));
...
const HajjTrainingVideosPage = lazy(() => import("./pages/HajjTrainingVideosPage"));
const ChangelogPage = lazy(() => import("./pages/ChangelogPage"));
const ZiyaratGuidePage = lazy(() => import("./pages/ZiyaratGuidePage"));
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background p-6" role="status" aria-live="polite">
      <div className="flex max-w-sm flex-col items-center gap-3 text-center">
        ...
        {timedOut ? <>
          <p className="text-sm font-medium text-foreground">This page is taking longer than expected.</p>
          <p className="text-sm text-muted-foreground">Please check your connection and try again.</p>
          <button type="button" onClick={() => window.location.reload()} className="min-h-11 rounded-lg bg-primary px-4 text-sm font-semibold text-primary-foreground">Retry page</button>
...
function AppContent() {
  return (
    <Routes>
      ...
      <Route path="/ziyarat" element={<ZiyaratGuidePage />} />
      {/* Keep the established Preparation experience as the default entry point. */}
      <Route path="/preparation" element={<PreparationGuidePage />} />
      <Route path="/preparation-guide" element={<PreparationGuidePage />} />
      ...
      <Route path="/daily-hajj-training" element={<DailyHajjTrainingPage />} />
      ...
      <Route path="/sukoon-tracking" element={<SukoonTrackingPage />} />
      <Route path="/sukoon-dashboard" element={<SukoonDashboardPage />} />
      ...
      <Route path="/pre-hajj-india/travel-preparation" element={<TravelPreparationGuidePage />} />
      ...
      <Route path="/coordinator" element={<StaffOnlyRoute><CoordinatorDashboardPage /></StaffOnlyRoute>} />
      <Route path="/medical-alerts" element={<StaffOnlyRoute><MedicalAlertsPage /></StaffOnlyRoute>} />
      <Route path="/cover-id-verify" element={<StaffOnlyRoute><CoverIdVerificationPage /></StaffOnlyRoute>} />
      ...
      <Route path="/inspector" element={<InspectorOnlyRoute><InspectorDashboardPage /></InspectorOnlyRoute>} />
      ...
      <Route path="/inspector-group" element={<InspectorOnlyRoute><InspectorGroupManagePage /></InspectorOnlyRoute>} />
      ...
      <Route path="/command-center" element={<StaffOnlyRoute><ResponderCommandPage /></StaffOnlyRoute>} />
      <Route path="/national-command" element={<AdminOnlyRoute><NationalCommandPage /></AdminOnlyRoute>} />
      ...
      <Route path="/admin/notices" element={<AdminOnlyRoute><AdminNoticesPage /></AdminOnlyRoute>} />
      <Route path="/admin/mission-directory" element={<AdminOnlyRoute><AdminMissionDirectoryPage /></AdminOnlyRoute>} />
      <Route path="/admin/training-videos" element={<AdminOnlyRoute><AdminTrainingVideosPage /></AdminOnlyRoute>} />
      <Route path="/admin/hajj-training-registrations" element={<AdminOnlyRoute><HajjTrainingRegistrationsAdminPage /></AdminOnlyRoute>} />

      <Route path="/free-umrah" element={<FreeUmrahApplyPage />} />
      <Route path="/free-hajj-training" element={<HajjTrainingRegistrationWizardPage />} />
      <Route path="/hajj-training-registration" element={<HajjTrainingRegistrationWizardPage />} />
