export const freeUmrahContent = {
  en: {
    ...
    masjidRegistrationNumber: "Masjid Registration Number",
    ...
    masjidCertificate: "1. Masjid Registration Certificate",
    passportPhoto: "2. Passport-size Photograph",
  ...
  ur: {
    ...
    masjidRegistrationNumber: "مسجد رجسٹریشن نمبر",
    ...
    masjidCertificate: "1. مسجد رجسٹریشن سرٹیفکیٹ",
    passportPhoto: "2. پاسپورٹ سائز تصویر",
  ...
  hi: {
    ...
    masjidRegistrationNumber: "मस्जिद पंजीकरण संख्या",
    ...
    masjidCertificate: "1. मस्जिद पंजीकरण प्रमाणपत्र",
    passportPhoto: "2. पासपोर्ट आकार की तस्वीर",
  ...
  ar: {
    ...
    masjidRegistrationNumber: "رقم تسجيل المسجد",
    ...
    masjidCertificate: "1. شهادة تسجيل المسجد",
    passportPhoto: "2. صورة بحجم جواز السفر",
    submit: "تقديم الطلب",
