 ...
 *   3. Last-known cached position (offline fallback)
 *
...
// --- Types ---
export type PositionSource = "gps" | "cell" | "cache";
...
export function useHybridPosition(config?: HybridPositionConfig) {
  ...
  const acquirePosition = useCallback(
    ...
    [getGpsPosition, getCellPosition, privacyPrecision]
  );
