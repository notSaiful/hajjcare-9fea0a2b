...
const labels = {
  title: {
    en: "Pilgrim Assistance Center",
    ar: "مركز مساعدة الحجاج",
    ur: "زائرین مدد مرکز",
    hi: "तीर्थयात्री सहायता केंद्र",
    ta: "யாத்ரீகர் உதவி மையம்",
    te: "యాత్రికుల సహాయ కేంద్రం",
    mr: "यात्रेकरू मदत केंद्र",
    bn: "তীর্থযাত্রী সহায়তা কেন্দ্র",
    or: "ତୀର୍ଥଯାତ୍ରୀ ସହାୟତା କେନ୍ଦ୍ର",
    ml: "തീർത്ഥാടക സഹായ കേന്ദ്രം",
    pa: "ਯਾਤਰੀ ਸਹਾਇਤਾ ਕੇਂਦਰ",
  },
  subtitle: {
    en: "Submit your concerns for immediate assistance",
    ar: "أرسل مخاوفك للحصول على مساعدة فورية",
    ur: "فوری مدد کے لیے اپنی تشویشات جمع کریں",
    hi: "फ़ौरी मदद के लिए अपनी परेशानी दर्ज करें",
    ta: "உடனடி உதவிக்கு உங்கள் கவலைகளை சமர்ப்பிக்கவும்",
    te: "తక్షణ సహాయం కోసం మీ సమస్యలను సమర్పించండి",
    mr: "त्वरित मदतीसाठी तुमच्या समस्या सादर करा",
    bn: "তাৎক্ষণিক সহায়তার জন্য আপনার সমস্যা জমা দিন",
    or: "ତୁରନ୍ତ ସହାୟତା ପାଇଁ ଆପଣଙ୍କ ଚିନ୍ତା ଦାଖଲ କରନ୍ତୁ",
    ml: "ഉടനടി സഹായത്തിനായി നിങ്ങളുടെ പ്രശ്നങ്ങൾ സമർപ്പിക്കുക",
    pa: "ਤੁਰੰਤ ਮਦਦ ਲਈ ਆਪਣੀ ਸਮੱਸਿਆ ਦਰਜ ਕਰੋ",
  },
  describeIssue: {
    en: "Describe your concern",
    ar: "صف مشكلتك",
    ur: "اپنی تشویش بیان کریں",
    hi: "अपनी परेशानी बयान करें",
    ta: "உங்கள் கவலையை விவரிக்கவும்",
    te: "మీ సమస్యను వివరించండి",
    mr: "तुमची समस्या वर्णन करा",
    bn: "আপনার সমস্যা বর্ণনা করুন",
    or: "ଆପଣଙ୍କ ଚିନ୍ତା ବର୍ଣ୍ଣନା କରନ୍ତୁ",
    ml: "നിങ്ങളുടെ പ്രശ്നം വിവരിക്കുക",
    pa: "ਆਪਣੀ ਸਮੱਸਿਆ ਦੱਸੋ",
  },
  placeholder: {
    en: "Describe your situation, when it started, and how urgent it is...",
    ar: "صف حالتك، متى بدأت، ومدى إلحاحها...",
    ur: "اپنی صورتحال بیان کریں، کب شروع ہوئی، اور کتنی ضروری ہے...",
    hi: "अपनी स्थिति बयान करें, कब शुरू हुई, और कितनी ज़रूरी है...",
    ta: "உங்கள் நிலையை விவரிக்கவும், எப்போது தொடங்கியது, எவ்வளவு அவசரமானது...",
    te: "మీ పరిస్థితిని వివరించండి, ఎప్పుడు మొదలైంది, ఎంత అత్యవసరమో...",
    mr: "तुमची परिस्थिती वर्णन करा, कधी सुरू झाली, किती तातडीची आहे...",
    bn: "আপনার পরিস্থিতি বর্ণনা করুন, কখন শুরু হয়েছে, কতটা জরুরি...",
    or: "ଆପଣଙ୍କ ପରିସ୍ଥିତି ବର୍ଣ୍ଣନା କରନ୍ତୁ, କେବେ ଆରମ୍ଭ ହେଲା, କେତେ ଜରୁରୀ...",
    ml: "നിങ്ങളുടെ സാഹചര്യം വിവരിക്കുക, എപ്പോൾ തുടങ്ങി, എത്ര അടിയന്തരമാണ്...",
    pa: "ਆਪਣੀ ਸਥਿਤੀ ਦੱਸੋ, ਕਦੋਂ ਸ਼ੁਰੂ ਹੋਈ, ਕਿੰਨੀ ਜ਼ਰੂਰੀ ਹੈ...",
  },
  submit: {
    en: "Submit for Help",
    ar: "إرسال للمساعدة",
