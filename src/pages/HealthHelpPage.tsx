...
const labels = {
  ...
  loginRequired: {
    en: "Please login to submit health requests",
    ar: "يرجى تسجيل الدخول لإرسال طلبات صحية",
    ur: "صحت کی درخواستیں جمع کرنے کے لیے لاگ ان کریں",
    hi: "सेहत की दरख्वास्त भेजने के लिए लॉगिन करें",
    ta: "சுகாதார கோரிக்கைகளை சமர்ப்பிக்க உள்நுழையவும்",
    te: "ఆరోగ్య అభ్యర్థనలు సమర్పించడానికి లాగిన్ చేయండి",
    mr: "आरोग्य विनंत्या सादर करण्यासाठी लॉगिन करा",
    bn: "স্বাস্থ্য অনুরোধ জমা দিতে লগইন করুন",
    or: "ସ୍ୱାସ୍ଥ୍ୟ ଅନୁରୋଧ ଦାଖଲ କରିବାକୁ ଲଗଇନ୍ କରନ୍ତୁ",
    ml: "ആരോഗ്യ അഭ്യർത്ഥനകൾ സമർപ്പിക്കാൻ ലോഗിൻ ചെയ്യുക",
    pa: "ਸਿਹਤ ਬੇਨਤੀਆਂ ਭੇਜਣ ਲਈ ਲਾਗਇਨ ਕਰੋ",
  },
  login: {
    en: "Login",
    ar: "تسجيل الدخول",
