...
const TelecomGuidePage = () => {
  ...
  const labels = {
    ...
    subtitle: {
      en: "Stay connected during your journey",
      ar: "ابقَ على اتصال خلال رحلتك",
      ur: "اپنے سفر کے دوران رابطے میں رہیں",
      hi: "अपनी यात्रा के दौरान जुड़े रहें",
      tr: "Yolculuğunuz sırasında bağlantıda kalın",
      ru: "Оставайтесь на связи во время путешествия",
    },
    back: {
      en: "Back",
      ar: "رجوع",
