...
const GrievancesPage = () => {
  ...
  const labels = {
    title: { en: "Grievances & Complaints", ar: "الشكاوى والمظالم", ur: "شکایات", hi: "शिकायतें", ta: "புகார்கள்", te: "ఫిర్యాదులు", mr: "तक्रारी", bn: "অভিযোগ", or: "ଅଭିଯୋଗ", ml: "പരാതികൾ", pa: "ਸ਼ਿਕਾਇਤਾਂ" },
    subtitle: { en: "How to report issues during Hajj", ar: "كيفية الإبلاغ عن المشاكل أثناء الحج", ur: "حج کے دوران مسائل کی رپورٹ کیسے کریں", hi: "हज के दौरान समस्याओं की रिपोर्ट कैसे करें", ta: "ஹஜ் நேரத்தில் சிக்கல்களை எவ்வாறு புகாரளிப்பது", te: "హజ్ సమయంలో సమస్యలను ఎలా నివేదించాలి", mr: "हज दरम्यान समस्यांची तक्रार कशी करावी", bn: "হজের সময় সমস্যা কীভাবে জানাবেন", or: "ହଜ୍ଜ ସମୟରେ ସମସ୍ୟା କିପରି ରିପୋର୍ଟ କରିବେ", ml: "ഹജ്ജ് സമയത്ത് പ്രശ്നങ്ങൾ എങ്ങനെ റിപ്പോർട്ട് ചെയ്യാം", pa: "ਹੱਜ ਦੌਰਾਨ ਸਮੱਸਿਆਵਾਂ ਦੀ ਰਿਪੋਰਟ ਕਿਵੇਂ ਕਰੀਏ" },
            ...
            <Card key={idx} className="border-2">
              <CardContent className="p-4 sm:p-5">
                <div className="flex items-center justify-between gap-4 mb-4">
                  ...
                  <TextToSpeechButton
                    text={`${section.title[language] || section.title.en}. ${section.content.map(item => item[language] || item.en).join('. ')}`}
                    size="icon"
                    variant="ghost"
                    showLabel={false}
                  />
