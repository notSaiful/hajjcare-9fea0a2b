...
const QurbaniPage = () => {
  ...
  return (
    <>
      <SEO title="Qurbani Booking" description="Plan Qurbani for Haj 2027 (1448H) with multilingual guidance. Confirm official booking availability before payment." path="/qurbani" type="website" jsonLd={{"@context":"https://schema.org","@type":"WebPage","headline":"Qurbani Booking","description":"Plan Qurbani for Haj 2027 (1448H) with multilingual guidance. Confirm official booking availability before payment.","url":"https://hajjcare.in/qurbani"}} />
