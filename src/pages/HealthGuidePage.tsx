...
const HealthGuidePage = () => {
  ...
  const labels = {
    ...
    subtitle: {
      en: "Stay healthy during your pilgrimage",
      ar: "حافظ على صحتك خلال الحج",
      ur: "حج کے دوران صحت مند رہیں",
      hi: "तीर्थयात्रा के दौरान स्वस्थ रहें",
      tr: "Hac sırasında sağlıklı kalın",
      ru: "Сохраняйте здоровье во время паломничества",
    },
    back: {
      en: "Back",
      ar: "رجوع",
