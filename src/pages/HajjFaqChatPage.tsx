...
const LABELS: Record<string, {
  ...
  en: {
    ...
    newChat: "New Chat",
    greeting: "Assalamu Alaikum! 🕋 I'm your Haj 2027 (1448H) FAQ assistant. Ask me about rituals, travel tips, health advice, or duas. Always verify time-sensitive travel requirements with official sources.",
    suggestions: [
  ...
  const sendMessage = useCallback(async (text: string) => {
    ...
    try {
      ...
      if (!session?.access_token) {
        throw new Error("Please sign in to use the FAQ chat.");
      }
