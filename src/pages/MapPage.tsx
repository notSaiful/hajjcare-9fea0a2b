...
const MapPage = () => {
  ...
  const getTimeSinceUpdate = useCallback((updatedAt: string) => {
  ...
  }, [memberLocations, memberId, showFamily, language, getStatusLabel, getTimeSinceUpdate]);
            ...
            <div className="mb-4 p-4 bg-card/80 rounded-2xl border border-border/40">
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-sm font-semibold">{language === "ar" ? "نظام سكون للتتبع – اتصال العائلة" : "Sukoon Tracking System – Family Connect"}</p>
                </div>
