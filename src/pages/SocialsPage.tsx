...
import { MessageCircle, Youtube, Instagram, AlertCircle, Twitter, Linkedin, Share2 } from "lucide-react";
...
const socialLinks = [
  ...
  },
  {
    id: "linkedin",
    icon: Linkedin,
    name: { en: "LinkedIn", ar: "لينكدإن", ur: "لنکڈ اِن", hi: "लिंक्डइन", ta: "லிங்க்ட்இன்", te: "లింక్డ్‌ఇన్", mr: "लिंक्डइन", bn: "লিংকডইন", or: "ଲିଙ୍କଡଇନ୍", ml: "ലിങ്ക്ഡ്ഇൻ", pa: "ਲਿੰਕਡਇਨ" },
    description: { en: "Rafiq Ul Harmain - Professional Profile", ar: "الملف المهني لرفيق الحرمين", ur: "رفیق الحرمین کا پیشہ ورانہ پروفائل", hi: "रफीक उल हरमैन - पेशेवर प्रोफ़ाइल", ta: "ரஃபிக் உல் ஹரமைன் - தொழில்முறை சுயவிவரம்", te: "రఫీక్ ఉల్ హరమైన్ - ప్రొఫెషనల్ ప్రొఫైల్", mr: "रफीक उल हरमैन - व्यावसायिक प्रोफाइल", bn: "রফিক উল হারামাইন - পেশাদার প্রোফাইল", or: "ରଫିକ ଉଲ ହରମାଇନ - ବୃତ୍ତିଗତ ପ୍ରୋଫାଇଲ", ml: "റഫീഖ് ഉൽ ഹറമൈൻ - പ്രൊഫഷണൽ പ്രൊഫൈൽ", pa: "ਰਫੀਕ ਉਲ ਹਰਮੈਨ - ਪੇਸ਼ੇਵਰ ਪ੍ਰੋਫਾਈਲ" },
    url: "https://www.linkedin.com/in/rafiq-ul-harmain-undefined-1016703a4",
    color: "bg-[#0A66C2]",
  },
  {
    id: "facebook",
    icon: Share2,
    name: { en: "Facebook", ar: "فيسبوك", ur: "فیس بک", hi: "फेसबुक", ta: "ஃபேஸ்புக்", te: "ఫేస్‌బుక్", mr: "फेसबुक", bn: "ফেসবুক", or: "ଫେସବୁକ୍", ml: "ഫേസ്ബുക്ക്", pa: "ਫੇਸਬੁੱਕ" },
    description: { en: "HajjCare Facebook Updates", ar: "تحديثات HajjCare على فيسبوك", ur: "HajjCare فیس بک اپڈیٹس", hi: "HajjCare फेसबुक अपडेट", ta: "HajjCare ஃபேஸ்புக் புதுப்பிப்புகள்", te: "HajjCare ఫేస్‌బుక్ అప్‌డేట్లు", mr: "HajjCare फेसबुक अपडेट", bn: "HajjCare ফেসবুক আপডেট", or: "HajjCare ଫେସବୁକ୍ ଅପଡେଟ୍", ml: "HajjCare ഫേസ്ബുക്ക് അപ്ഡേറ്റുകൾ", pa: "HajjCare ਫੇਸਬੁੱਕ ਅੱਪਡੇਟ" },
    url: "https://www.facebook.com/share/p/1BpoqCgvsq/",
    color: "bg-[#1877F2]",
  },
  {
    id: "instagram",
