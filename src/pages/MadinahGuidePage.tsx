...
const MadinahGuidePage = () => {
  ...
  const labels = {
    title: {
      ...
      tr: "Medine Adabı Rehberi",
      ru: "Руководство по этикету Медины",
    },
    subtitle: {
      ...
      tr: "Mescid-i Nebevi'de ve Peygamber'in şehrinde doğru davranış",
      ru: "Правильное поведение в Мечети ан-Набави и городе Пророка",
    },
    complete: {
      ...
      tr: "Tüm Medine adabını gözden geçirdiniz",
      ru: "Вы просмотрели весь этикет Медины",
    },
  };
