...
const trainingMaterials: TrainingMaterial[] = [
  ...
  },
  {
    ...
    description: { en: "Haj 2027 (1448H) presentation for training sessions", ar: "عرض الحج 2027 للتدريب", ur: "حج 2027 تربیتی پریزنٹیشن", hi: "हज 2027 प्रशिक्षण प्रस्तुति" },
...
const translations = {
  en: {
    ...
    subtitle: "State Haj Inspector training resources for Haj 2027 (1448H)",
    download: "Download",
                ...
                <CardContent className="p-4">
                  <div className="flex items-start gap-4">
                    <IconCircle 
                      icon={material.icon} 
                      size="sm" 
                      variant={material.color as IconCircleVariant}
                    />
