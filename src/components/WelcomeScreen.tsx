  ...
  return (
    <div className="flex flex-col items-center text-center px-4 py-6">
      ...
      <h2 className="font-arabic text-2xl font-bold text-foreground mb-1 animate-fade-up" style={{ animationDelay: "100ms" }}>
        {t("السلام عليكم", "Assalamu Alaikum")}
      </h2>
      <p className="text-base text-muted-foreground mb-1 animate-fade-up" style={{ animationDelay: "150ms" }}>
        {t("أهلاً بك أيها الحاج الكريم", "Welcome, Dear Pilgrim")}
      </p>
      
      {/* Subtitle */}
      <p className="text-xs text-muted-foreground max-w-xs mb-4 animate-fade-up" style={{ animationDelay: "200ms" }}>
        {t(
          "أنا مرشدك للحج. اسألني عن المناسك أو الأدعية أو أي إرشادات عملية.",
          "I'm your Hajj guide. Ask me about rituals, duas, or practical guidance."
        )}
      </p>

      {/* Live Map */}
      <div className="w-full max-w-sm mb-4 animate-fade-up" style={{ animationDelay: "250ms" }}>
        <HajjMap 
      ...
      {/* Quick Actions */}
      <div className="w-full max-w-sm animate-fade-up" style={{ animationDelay: "350ms" }}>
        <p className="text-xs text-muted-foreground mb-3 font-medium">
          {t("أسئلة سريعة", "Quick Questions")}
        </p>
