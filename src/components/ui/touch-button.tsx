...
/**
 * TouchButton - Optimized for instant tactile feedback
 * Provides immediate visual response on press for a responsive feel
 */
  ...
  `,
  {
    variants: {
      ...
      size: {
        ...
        xl: "h-13 sm:h-14 rounded-xl px-6 text-base",
        icon: "h-10 w-10",
      },
    },
    defaultVariants: {
