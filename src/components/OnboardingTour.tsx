    ...
    options: [
      {
        ...
        tipKey: L(
          "Set up 'Sukoon Tracking System – Family Connect' from the home screen to stay connected. Share locations and see everyone’s status in real time.",
          "ابقَ على اتصال عبر إعداد «نظام سكون للتتبع – اتصال العائلة» من الصفحة الرئيسية. شارك المواقع وتابع حالة الجميع مباشرة.",
          "جڑے رہنے کے لیے ہوم اسکرین سے «سکون ٹریکنگ سسٹم – فیملی کنیکٹ» سیٹ اپ کریں۔ مقامات شیئر کریں اور سب کی حالت براہِ راست دیکھیں۔",
          "जुड़े रहने के लिए होम स्क्रीन से ‘सुकून ट्रैकिंग सिस्टम – फैमिली कनेक्ट’ सेट करें। स्थान साझा करें और सभी की स्थिति रीयल-टाइम में देखें।"
        ),
      },
      {
        value: "alone",
