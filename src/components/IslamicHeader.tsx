      ...
      <div className="container flex items-center justify-between h-14 px-4">
        ...
        <div className="flex items-center gap-1">
          <Link to="/sukoon-tracking">
            <Button aria-label="Open Sukoon Tracking System" variant="ghost" size="sm" className="h-8 px-2 text-primary-foreground/80 hover:text-primary-foreground hover:bg-primary-foreground/10">
              <Users className="w-4 h-4" />
            </Button>
          </Link>
          <Link to="/map">
            <Button aria-label="Open map" variant="ghost" size="sm" className="h-8 px-2 text-primary-foreground/80 hover:text-primary-foreground hover:bg-primary-foreground/10">
