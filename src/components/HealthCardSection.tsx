...
const labels: Record<string, LocalizedString> = {
  title: {
    en: "Health Card for Haj Pilgrims",
    ar: "البطاقة الصحية لحجاج بيت الله",
    ur: "حج زائرین کے لیے ہیلتھ کارڈ",
    hi: "हज यात्रियों के लिए हेल्थ कार्ड",
    ta: "ஹஜ் புனிதப்பயணிகளுக்கான சுகாதார அட்டை",
    te: "హజ్ యాత్రికులకు ఆరోగ్య కార్డు",
    mr: "हज यात्रेकरूंसाठी आरोग्य कार्ड",
    bn: "হজ তীর্থযাত্রীদের জন্য স্বাস্থ্য কার্ড",
    or: "ହଜ ତୀର୍ଥଯାତ୍ରୀଙ୍କ ପାଇଁ ସ୍ୱାସ୍ଥ୍ୟ କାର୍ଡ",
    ml: "ഹജ്ജ് തീർത്ഥാടകർക്കുള്ള ആരോഗ്യ കാർഡ്",
    pa: "ਹੱਜ ਯਾਤਰੀਆਂ ਲਈ ਹੈਲਥ ਕਾਰਡ",
  },
  subtitle: {
    en: "Official medical screening document issued by Ministry of Minority Affairs",
    ar: "وثيقة الفحص الطبي الرسمية الصادرة عن وزارة شؤون الأقليات",
    ur: "وزارت اقلیتی امور کی جانب سے جاری سرکاری طبی جانچ دستاویز",
    hi: "अल्पसंख्यक मामलों के मंत्रालय द्वारा जारी आधिकारिक चिकित्सा जांच दस्तावेज़",
    ta: "சிறுபான்மை விவகார அமைச்சகம் வெளியிட்ட அதிகாரப்பூர்வ மருத்துவ பரிசோதனை ஆவணம்",
    te: "మైనారిటీ వ్యవహారాల మంత్రిత్వ శాఖ జారీ చేసిన అధికారిక వైద్య పరీక్ష పత్రం",
    mr: "अल्पसंख्याक व्यवहार मंत्रालयाने जारी केलेला अधिकृत वैद्यकीय तपासणी दस्तऐवज",
    bn: "সংখ্যালঘু বিষয়ক মন্ত্রণালয় দ্বারা জারি করা অফিসিয়াল মেডিকেল স্ক্রিনিং নথি",
    or: "ସଂଖ୍ୟାଲଘୁ ବିଷୟ ମନ୍ତ୍ରଣାଳୟ ଦ୍ୱାରା ଜାରି ଅଫିସିଆଲ୍ ମେଡିକାଲ୍ ସ୍କ୍ରିନିଂ ଡକ୍ୟୁମେଣ୍ଟ",
    ml: "ന്യൂനപക്ഷ കാര്യ മന്ത്രാലയം പുറപ്പെടുവിച്ച ഔദ്യോഗിക മെഡിക്കൽ സ്ക്രീനിംഗ് രേഖ",
    pa: "ਘੱਟ ਗਿਣਤੀ ਮਾਮਲਿਆਂ ਦੇ ਮੰਤਰਾਲੇ ਦੁਆਰਾ ਜਾਰੀ ਅਧਿਕਾਰਤ ਮੈਡੀਕਲ ਸਕ੍ਰੀਨਿੰਗ ਦਸਤਾਵੇਜ਼",
  },
  whatIsIt: {
